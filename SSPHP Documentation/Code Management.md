...
The Repo is organised with a directory for [SSPHP](../SSPHP) (the app that is deployed onto the Splunk Search Head), and a directory for the [TA](./TA_SSPHP) code that is deployed to the [Heavy Forwarder](./TA%20Heavy%20Forwarder%20Architcture.md).
