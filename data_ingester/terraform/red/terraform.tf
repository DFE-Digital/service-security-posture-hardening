...
locals {
  ...
  key_vault_object_ids = ["393279ef-dc89-4bff-8186-4d283ee7b280", "7e53a6ad-8c94-4d82-a3b5-222882dffc29", "0870054a-44a7-4ddf-af8d-e48276f81df4"] # 7e53 = GitHub Actions - TODO; check if still required
}
